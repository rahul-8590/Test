	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-horizontal">
				...
				<form class="form-horizontal userregister" method="POST" action="?link=registeruser">
					<div class="panel panel-default">

						<div class="panel-heading">
							<h3 class="panel-title"><strong>Register User</strong></h3>
						</div>
						...
						<div class="panel-body">                            
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-xs-12">
									<input type="text" name="dob" id="datetimepicker1" class="form-control" placeholder="Enter Your Date of Birth" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-xs-12">
									<textarea type="text" name="about" class="form-control" placeholder="Tell us something about yourself..." ></textarea>
								</div>
							</div>
